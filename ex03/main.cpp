...
/*   Updated: 2026/08/11 13:36:05 by dtrendaf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main ()
{
    ...
    //     std::cerr << e.what() << std::endl;
    // }
    std::cout << "\033[31m\n----- Intern test cases -----\033[0m" << std::endl;
    ...
    // valid form creation through intern
    try
    {
        AForm *form = intern.makeForm("robotomy request", "LeoDicabriole");
        if (form)
        {
            bob.signForm(*form);
            form->execute(bob);
    ...
    {
        std::cerr << "Valid intern form error: " << e.what() << std::endl;
    }

    std::cout << "\033[31m\n----- Intern invalid form request -----\033[0m" << std::endl;
    AForm *wrong = intern.makeForm("not a real form", "Nobody");
    if (wrong)
        delete wrong;

    std::cout << "\033[31m\n----- Intern created PresidentialPardonForm -----\033[0m" << std::endl;
    try
    {
    ...
    {
        std::cerr << "Pardon intern error: " << e.what() << std::endl;
    }

    std::cout << "\033[31m\n----- Intern shrubbery fail case -----\033[0m" << std::endl;
    try
    {
